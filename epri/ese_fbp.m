...
function FinalImage = ese_fbp(file_name, file_suffix, output_path, fields)
...
if is_fit_data
  [FinalImage.fit_data] = epri_decay_fit(FinalImage.Raw, FinalImage.raw_info.tau2(:)'*1E6, fields.fit);
