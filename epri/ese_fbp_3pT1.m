...
function FinalImage = ese_fbp_3pT1(file_name, file_suffix, output_path, fields)
...
if is_fit_data
  [FinalImage.fit_data] = epri_decay_fit(FinalImage.Raw, FinalImage.raw_info.T1(:)'*1E6, fields.fit);
