...
fbp_struct = epri_DecodeImageType('RS12A10T4G2.1551S1P3Z0O0N0');
fbp_struct.deltaL =3;
...
R = 1.2; % Radius of the big sphere
Rs = 0.4; % Radius of the small spheres
a = 1;  % offset value compared to the center
nBins = 64;
...
recon_pars.nBins = 6;  % this par is ignored, radon_pars are used
recon_pars.Filter = 'ram-lak';
recon_pars.FilterCutOff = 1.0;
recon_pars.Interpolation = 'spline';
recon_pars.InterpFactor = 2;4 % better 4
